...
def max(img, mascara):
    ...
    for x in range(raio, linhas - raio):
        ...
        for y in range(raio, colunas - raio):
            ...
            max_lista = (len(mediana) - 1)

            # seta o pixel da nova imagem com o valor do meio da lista
            img_filtrada.itemset((x, y), mediana[max_lista])
...
if __name__ == '__main__':
    ...
    # salvar imagens
    cv2.imwrite('resultados/ex7_original.png', img)
    cv2.imwrite('resultados/ex7_resultado.png', img_filtrada)
